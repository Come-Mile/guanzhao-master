...
- (void)setupBg
{
    ...
    selectedBg.backgroundColor = MWColor(237, 233, 218);
...
- (void)layoutSubviews
{
    ...
    self.textLabel.frame = CGRectMake(self.textLabel.frame.origin.x, (self.frame.size.height - self.textLabel.frame.size.height)/2.0, self.textLabel.frame.size.width, self.textLabel.frame.size.height);
    self.detailTextLabel.frame = CGRectMake(self.detailTextLabel.frame.origin.x, 0, self.detailTextLabel.frame.size.width, self.frame.size.height);
