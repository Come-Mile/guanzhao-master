...
-(instancetype)init
{
    ...
    self.backgroundColor = [UIColor colorWithRed:0.400 green:0.600 blue:0.000 alpha:1.000];
...
{
    if (iOS7) {
        self.summitBtn = [[UIButton alloc]initWithFrame:CGRectMake(ScreenW -60,20, 60, 44)];
    }else{
        self.summitBtn = [[UIButton alloc]initWithFrame:CGRectMake(ScreenW -60, 20, 60, 44)];
    }
